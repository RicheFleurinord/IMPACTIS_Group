...
export const t = {
    ...
    about_page: {
        ...
        team: {
            ...
            sub: { fr: "Une equipe de co-fondateurs et membres aux competences complementaires, unis par une vision commune.", en: "A team of co-founders and members with complementary skills, united by a common vision." },
            ...
            cofounders: [
                {
                    ...
                    bio: { fr: "Il joue un role central dans la structuration, la coordination et l'execution des initiatives du groupe. A l'origine de l'idee initiale de KobMwen, enrichie et developpee collaborativement pour devenir une solution fintech complete. Economiste-statisticien avec competences en data science, comptabilite et analyse financiere.", en: "He plays a central role in structuring, coordinating and executing group initiatives. Originally conceived KobMwen, later developed collaboratively into a full fintech solution. Economist-statistician with data science, accounting and financial analysis skills." },
                },
                {
                    ...
                    bio: { fr: "Il occupe un role hybride combinant expertise technique et communication. Il contribue a la modelisation de donnees, l'analyse statistique et la construction de rapports avances. Son expertise en data science lui permet de developper des modeles analytiques essentiels aux solutions du groupe.", en: "He holds a hybrid role combining technical expertise and communication. He contributes to data modeling, statistical analysis and advanced reporting. His data science expertise enables him to develop analytical models essential to group solutions." },
                },
                {
                ...
                },
                {
                    ...
                    role: { fr: "Co-Founder", en: "Co-Founder" },
                    dept: { fr: "Head of Product & Dashboard", en: "Head of Product & Dashboard" },
                    bio: { fr: "Il a contribue au projet BankChurnAI, principalement sur les aspects lies aux donnees et aux dashboards analytiques. Membre d'IMPACTIS Group, il participe aux initiatives du groupe a travers des contributions techniques et analytiques.", en: "He contributed to the BankChurnAI project, mainly on data and analytical dashboard aspects. Member of IMPACTIS Group, he participates in group initiatives through technical and analytical contributions." },
                },
                {
                    name: "Newton FANFAN",
                    initials: "NF",
            ...
            members: [
                {
                    ...
                    dept: { fr: "Technical Contributor", en: "Technical Contributor" },
                    bio: { fr: "Computer scientist et statisticien de formation, il a apporte son expertise technique lors du projet EduKonekte. Il contribue aux initiatives du groupe sur les aspects technologiques et analytiques.", en: "Computer scientist and statistician by training, he brought his technical expertise to the EduKonekte project. He contributes to group initiatives on technological and analytical aspects." },
                },
                {
                    ...
                    role: { fr: "Membre", en: "Member" },
                    dept: { fr: "Economic Planning Contributor", en: "Economic Planning Contributor" },
                    bio: { fr: "Economiste et planificateur de formation, il a contribue a la realisation du projet KobMwen. Il participe aux initiatives du groupe a travers des contributions en analyse economique et en planification.", en: "Economist and planner by training, he contributed to the KobMwen project. He participates in group initiatives through economic analysis and planning contributions." },
                },
                {
                    name: "Saint-Vil RENE",
                    initials: "SR",
                    ...
                    role: { fr: "Membre", en: "Member" },
                    dept: { fr: "Engineering & Technology Contributor", en: "Engineering & Technology Contributor" },
                    bio: { fr: "Computer engineer et economiste de formation, il a apporte une contribution au projet EduKonekte en mettant a profit ses competences techniques et economiques. Il participe aux differentes initiatives technologiques du groupe.", en: "Computer engineer and economist by training, he contributed to the EduKonekte project leveraging his technical and economic skills. He participates in the group's various technological initiatives." },
                },
                {
                    ...
                    bio: { fr: "Specialiste en systemes d'information et BI Analyst, il a participe au projet KobMwen en tant que consultant en appui technique. Il contribue aux reflexions techniques et analytiques liees aux projets du groupe.", en: "Information systems specialist and BI Analyst, he participated in the KobMwen project as a technical support consultant. He contributes to technical and analytical thinking across group projects." },
                },
                {
                    ...
                    photo: null,
                    role: { fr: "Membre", en: "Member" },
                    dept: { fr: "Software Engineering & Telecom", en: "Software Engineering & Telecom" },
                    bio: { fr: "Ingenieur en electronique et developpement logiciel, il evolue dans le secteur des telecommunications ou il contribue a l'exploitation et l'optimisation de plateformes critiques a haute disponibilite. Passionne par la conception d'applications robustes et evolutives, il apporte son expertise en architecture logicielle et developpement d'interfaces modernes au groupe.", en: "Electronics and software development engineer working in telecommunications, contributing to the operation and optimization of high-availability critical platforms. Passionate about building robust and scalable applications, he brings his expertise in software architecture and modern interface development to the group." },
                },
            ],
        },
    },
    ...
    startups_data: [

        {
            ...
            problem: {
                fr: "70% de la population haitienne n'a pas acces aux services bancaires. Les groupes d'epargne (sols) sont informels, sans tracabilite ni historique bancaire.",
            ...
            solution: {
                fr: "Plateforme numerique qui digitalise les sols, genere des scores de credit alternatifs et connecte les membres non-bancarises aux institutions de microfinance.",
            ...
            impact: {
                fr: "100+ communautes digitalisees (An 1), 10K+ membres avec profil financier numerique, 3K+ acces au microcredit",
        ...
        },
        {
            ...
            problem: {
                fr: "Les banques haitiennes perdent des clients sans pouvoir anticiper ou comprendre les raisons du depart. Cout eleve d'acquisition vs. retention.",
            ...
            solution: {
                fr: "Agent IA qui analyse les donnees demographiques et comportementales pour predire le churn, identifier les raisons d'attrition et generer des recommandations personnalisees en FR et creole haitien.",
            ...
            recognition: {
                fr: "Presente devant les executives de la BRH (Banque de la Republique d'Haiti) — felicite pour son innovation et sa pertinence pour le secteur bancaire haitien.",
            ...
            desc: {
                fr: "Agent IA de prediction du churn bancaire presente au Ayiti AI Hackathon 2025, reconnu par le jury BRH.",
        ...
        },
        {
            ...
            problem: {
                fr: "L'acces a une education connectee et de qualite reste limite dans les communautes defavorisees haitiennes.",
                en: "Access to connected and quality education remains limited in disadvantaged Haitian communities.",
            },
            solution: {
                fr: "Plateforme EdTech pour connecter les jeunes des communautes defavorisees a des ressources educatives de qualite et a des opportunites d'apprentissage.",
            ...
            competition: {
                fr: "Hult Prize Foundation — competition mondiale d'entrepreneuriat social et innovation.",
                en: "Hult Prize Foundation — global social entrepreneurship and innovation competition.",
            },
            desc: {
                fr: "Initiative EdTech developpee dans le cadre du Hult Prize Foundation 2024-2025 pour democratiser l'acces a l'education en Haiti.",
    ...
    contact_page: {
        ...
        form: {
            ...
            success: { fr: "Message envoye avec succes! Nous vous repondrons bientot.", en: "Message sent successfully! We'll get back to you soon." },
        ...
        info: {
            ...
            avail: { fr: "Disponibilite", en: "Availability" },
